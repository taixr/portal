...
![Python自动化脚本-运维人员宝典第一章 Python脚本概述](https://i.taixr.com/2019021602502453.jpeg)
...
![Python自动化脚本-运维人员宝典第一章 Python脚本概述](https://i.taixr.com/2019021707562267.jpeg)
...
![Python自动化脚本-运维人员宝典第一章 Python脚本概述](https://i.taixr.com/2019021708122270.jpeg)
...
Python中的迭代器是可进行迭代的对象。这个对象会返回数据，每次返回一个元素。Python的迭代器对象实现了两个方法：**iter**()和**next**()。大多数情况下迭代器在循环、生成器和推导式中实现。
